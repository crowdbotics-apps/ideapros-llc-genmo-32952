...
## Project Structure
    ...
    ├── ideapros_llc_genmo_32952  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_genmo_32952`
...
2. Clone this repo and `cd ideapros_llc_genmo_32952`
